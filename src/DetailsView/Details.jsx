...
export default function Details(){
    ...
    return(
        ...
        <section className="w-[1200px] mx-auto py-[50px] mobileS:w-[320px] mobileM:w-[375px] mobileL:w-[425px]">
            <div className="w-full grid grid-cols-[40%_60%] gap-x-8 items-center mobileS:grid-cols-1 mobileM:grid-cols-1 mobileL:grid-cols-1">
                ...
                <div>
                    ...
                    <div className="flex flex-row justify-between w-[80%] mobileS:flex-col mobileS:items-center mobileM:flex-col mobileM:items-center mobileL:flex-col mobileL:items-center">
                        <div>
                    ...
                    <div className="w-[80%] text-lg font-serif font-medium text-justify my-[25px] mobileS:mx-auto mobileM:mx-auto mobileL:mx-auto">
                        <p className={`${themeMode?"text-blue-950":"text-white"}`}>
                            {description}
                        </p>
                    </div>

                    <div className="flex flex-row justify-between w-[80%] mobileS:mx-auto mobileS:text-center mobileM:mx-auto mobileM:text-center mobileL:text-center mobileL:mx-auto">
                        <div>
                            <p className={`font-medium text-base text-gray-600/50 capitalize ${themeMode?"text-blue-950":"text-white"}`}>

  ...
  return (
    ...
    <ToastContainer
      ...
      Update Your Craft Item
        ...
        <div className="w-full grid grid-cols-[40%_60%] gap-x-6 mt-[50px] mobileS:grid-cols-1 mobileM:grid-cols-1 mobileL:grid-cols-1 tablet:grid-cols-1 tablet:w-[90%] tablet:mx-auto">

  ...
  return (
    ...
    <ToastContainer
      ...
      Add Your Craft Item
        ...
        <div className={`w-full grid grid-cols-[40%_60%] gap-x-6 mt-[50px] ${themeMode?"text-blue-950":"text-white"} mobileS:grid-cols-1 mobileM:grid-cols-1 mobileL:grid-cols-1`}>

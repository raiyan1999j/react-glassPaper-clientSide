...
export default function Home() {
  ...
  return (
    <>
      <section className="w-[1200px] mx-auto pt-[50px] mobileS:w-[320px] mobileM:w-[375px]">
        <div className="w-[1000px] mx-auto mobileS:w-[280px] mobileM:w-[300px]">
          <Swiper
            autoplay={{
              delay: 8000,
              ...
              return (
                <SwiperSlide key={id}>
                  <div className="h-[500px] w-full relative">
                    ...
                    <div className="absolute w-[40%] left-0 top-[50%] py-4 px-2 rounded-r-lg text-white bg-gradient-to-tr from-black to-gray-500 mobileS:h-full mobileS:top-0 mobileM:h-full mobileM:top-0">
                      <p>
                        {value.description}
                      </p>
                    </div>
      ...
      <section className="w-[1200px] mx-auto my-[50px] mobileS:w-[320px] mobileM:w-[375px]">
        ...
        <div className="grid grid-cols-3 gap-x-5 gap-y-5 w-[90%] mx-auto mobileS:grid-cols-1 mobileM:grid-cols-1">
        {

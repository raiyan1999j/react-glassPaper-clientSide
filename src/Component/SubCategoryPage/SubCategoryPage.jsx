...
export default function SubCategoryPage(){
    ...
    return(
        ...
        <section className="w-[1200px] mx-auto my-[50px] mobileS:w-[320px] mobileM:w-[375px] mobileL:w-[425px] tablet:w-[768px] laptop:w-[1024px]">
            ...
            <div className="w-full grid grid-cols-3 gap-x-6 gap-y-6 mobileS:grid-cols-1 mobileM:grid-cols-1 mobileL:grid-cols-1 tablet:grid-cols-2 tablet:w-[90%] tablet:mx-auto laptop:w-[90%] laptop:mx-auto">
                {

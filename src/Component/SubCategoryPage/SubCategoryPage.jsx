...
export default function SubCategoryPage(){
    ...
    return(
        <>
        <section className="w-[1200px] mx-auto my-[50px] smallest:w-[476px] small:w-[668px]">
            ...
            <div className="w-full grid grid-cols-3 gap-x-6 gap-y-6 smallest:grid-cols-1 small:grid-cols-2">
                {

  ...
  return (
    <>
      <section className="w-[1200px] mx-auto py-[50px] mobileS:w-[320px]">
        <div className="w-full grid grid-cols-[20%_80%] gap-x-4 mobileS:grid-cols-1">
          <div>
          ...
          <div className="w-full mt-[50px] grid grid-cols-3 gap-x-4 gap-y-8 mobileS:grid-cols-1">
            {

...
export default function App(){
    const {changeTheme,themeMode} = useContext(InfoProvider);
    ...
    return(
        <>
            <section className={`h-[80px] w-full ${themeMode?"bg-gradient-to-tr from-purple-600 to-purple-300":"bg-gradient-to-tr from-slate-900 to-slate-500"}  flex justify-center items-center`}>
                <nav className="w-[1200px] mx-auto text-white flex flex-row items-center">
                    ...
                    <div className="w-[20%] flex flex-row justify-between">
                        <div className="flex flex-row justify-between">
                            <button className="mr-4 btn" onClick={loginPage}>Login</button>
  ...
  <input type="checkbox" onClick={()=>{changeTheme(!themeMode)}}/>
